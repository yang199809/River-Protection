...
model = YOLO("yolo11m-seg.yaml")
model = YOLO("yolo11m-seg.pt")
results = model.train(data="Gaofen-seg.yaml", epochs=300, batch=4, imgsz=800, pretrained=True, seed=42,
                      optimizer='AdamW', lr0=0.0005)
'''
...
results = model.train(data="waterway.yaml", epochs=300, batch=4, imgsz=800, pretrained=True, seed=42,
                      optimizer='AdamW', lr0=0.0005)
